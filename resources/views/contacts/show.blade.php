    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <a href=" {{ route('contacts.edit', $contact) }}" class="btn btn-sm btn-outline-success mr-1 mt-2 float-left"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                <form action="{{route('contacts.destroy',$contact)}}" method="POST">
                        {{method_field('DELETE')}}
                        {{csrf_field()}}
                        <button class="btn btn-sm btn-outline-danger mr-1 mt-2"><i class="fa fa-trash" aria-hidden="true"></i></button>
                </form>
                <hr />
